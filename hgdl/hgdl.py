...
from .optima import optima_constr
...
class HGDL:
    ...
    In this class, while constraints can be 
    provided and enforced, points on the constrainsts 
    cannot be deflated and can
    therefore be reidentified which 
    leads to duplicate entries
    in the result. Use HGDLconstr for 
    deflating the constrants.
...
class HGDLconstr(HGDL):
    ...
    def __init__(self, func, grad, bounds,
       ...
       super()__init__(self.L, self.Lgrad, bounds, 
               hess = self.Lhess, num_epochs = num_epochs,
               global_optimizer = global_optimizer,
               local_optimizer=local_optimizer,
               number_of_optima = number_of_optima,
               local_max_iter = local_max_iter,
               args = args)


        self.optima = optima_constr(self.dim_x, self.dim_k,number_of_optima)
        logger.debug("HGDL successfully initiated {}")
